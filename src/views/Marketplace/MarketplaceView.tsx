...
export function MarketplaceView({ initialCategory, onSelectTemplate }: MarketplaceViewProps) {
  ...
  if (isLoading) return <LoadingState message={t('marketplace.loading_catalog')} />;
  ...
  const sorted = [...filtered].sort((a, b) => {
    // Priority: anthropic > claudecodeimpact > community
  ...
  return (
    <ConfigPage>
      <PageHeader
        title={categoryLabel}
        subtitle={t('marketplace.browse_category_templates', { category: categoryLabel.toLowerCase() })}
      />
