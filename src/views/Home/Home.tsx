          ...
          <div className="bg-card/50 rounded-2xl p-5 border border-border/40">
            ...
            {stats && (
              <div className="flex items-center gap-6 mt-4 pt-4 border-t border-border/40 text-sm text-muted-foreground">
                ...
                <span>
                  <strong className="text-foreground font-serif">{stats.commands}</strong> {t('home.stats.commands')}
                </span>
              </div>
            )}
          </div>
          ...
          <div className="bg-card/50 rounded-2xl p-5 border border-border/40">
            ...
            <div className="grid grid-cols-2 gap-2">
              {FEATURES.map((feature) => (
                ...
                >
                  <span
                    className={`text-sm ${feature.available ? "text-foreground" : "text-muted-foreground/60"
                      }`}
                  >
                    {t(`features.${feature.type}`)}
                  </span>
                  {!feature.available && (
