...
export function FeatureTabGroup({
              ...
              <TooltipTrigger asChild>
                <ContextMenuTrigger asChild>
                  <button
                    ...
                    className={`flex items-center gap-1.5 px-2 py-1 rounded-lg transition-colors cursor-grab active:cursor-grabbing ${isDragging
  ...
  return (
    <>
      <div className={`flex items-center flex-shrink-0 ${isDragging ? "opacity-50" : ""}`}>
        <div
          className={`relative flex items-center gap-0.5 px-1 pb-1 after:absolute after:bottom-0 after:left-1 after:right-1 after:h-0.5 after:rounded-full ${isDragging
            ...
            <ContextMenu>
              <TooltipTrigger asChild>
                <ContextMenuTrigger asChild>
                  <button
                    onClick={features.length > 0 ? toggleCollapsed : handleSelectProject}
                    className={`flex items-center px-1 py-1 rounded transition-colors flex-shrink-0 cursor-grab active:cursor-grabbing ${isActiveProject ? "text-primary" : "text-muted-foreground hover:text-ink"
                      }`}
                    {...dragHandleProps}
                  >
                    <ProjectLogo projectPath={project.path} size="sm" />
